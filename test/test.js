...
function itTestArray(t, g, gs, e) {
  it(`recover master secret for ${t} shares (threshold=${t}) of ${g} '[1, 1,]' groups with extendable backup flag set to ${e}",`, () => {
    ...
    let recoveredSecret = slip39.recoverSecret(mnemonics, PASSPHRASE);
